...
<div class="site-user__create_ticket" id="page_wrapper">
    ...
    <div>
        <div class="mb-3 field-ticket-title required" bis_skin_checked="1">
            ...
            <input type="text" value="Image is not epxosed" id="ticket-title" class="col-lg-3 form-control">
        </div>
        ...
        <div class="mb-3 field-ticket-description required" bis_skin_checked="1">
            ...
            <input type="text" value="It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like)." id="ticket-description" class="col-lg-3 form-control">
        </div>
        ...
        <div class="form-group d-flex flex-column align-items-center flex-sm-row justify-content-center gap-3">
            <?= Html::submitButton('Update', ['class' => 'btn btn-primary', 'name' => 'edit-button', 'data' => ['open-update-modal' => 'true']]) ?>
            <?= Html::a(
                'Cancel',
                '/',
                [
